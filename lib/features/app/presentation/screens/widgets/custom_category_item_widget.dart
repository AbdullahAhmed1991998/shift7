...
class CustomCategoryItemWidget extends StatelessWidget {
  ...
  Widget _buildCategoryImage() {
    final imageUrl = category.media.isNotEmpty ? category.media[0].url : '';
    return Container(
  ...
  String _getCategoryName() {
    ...
    if (category.nameAr.isNotEmpty && isArabic == true) {
      return category.nameAr;
    } else if (category.nameEn.isNotEmpty && isArabic == false) {
