...
class CustomSubAdWidget extends StatefulWidget {
  const CustomSubAdWidget({super.key});

  @override
  State<CustomSubAdWidget> createState() => _CustomSubAdWidgetState();
}

class _CustomSubAdWidgetState extends State<CustomSubAdWidget> {
  @override
...
class _SuccessAd extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final banners = stores.media.where((m) => m.name == 'sub_banner_image');
