...
class CustomBestSellerCardWidget extends StatefulWidget {
  final ProductItemModel item;
  const CustomBestSellerCardWidget({super.key, required this.item});

  @override
  State<CustomBestSellerCardWidget> createState() =>
      _CustomBestSellerCardWidgetState();
}

class _CustomBestSellerCardWidgetState
    extends State<CustomBestSellerCardWidget> {
