...
class CustomNewArrivalsCardWidget extends StatefulWidget {
  final ProductItemModel item;
  const CustomNewArrivalsCardWidget({super.key, required this.item});

  @override
  State<CustomNewArrivalsCardWidget> createState() =>
      _CustomNewArrivalsCardWidgetState();
}

class _CustomNewArrivalsCardWidgetState
    extends State<CustomNewArrivalsCardWidget> {
